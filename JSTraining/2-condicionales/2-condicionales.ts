...
const mes: string = "febrero";
const dia: number = 30;

if (mes.toLowerCase().trim() === "febrero" && dia >= 30) {
...
type gruposCesde = "throwers" | "catchers";

const grupo1: gruposCesde = "catchers";
const grupo2: gruposCesde = "throwers";

if (grupo1 && grupo2) {
  console.log("ambos grupos son del cesde");
}
...
const newGrupo1: Group = GROUPS.CATCHERS;
const newGrupo2: Group = GROUPS.THROWERS;

if (newGrupo1 && newGrupo2) {
  console.log("ambos grupos son del cesde");
}
