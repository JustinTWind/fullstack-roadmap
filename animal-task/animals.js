const animalsCollection = [
  ...
  // 2. Giraffe
  {
    ...
    weightKg: 1100,
    color: "Spotted Brown",
    habitat: ["Savanna", "Open Woodlands"],
  },
  // 3. Cheetah
  {
  ...
  // 19. Arctic Fox
  {
    ...
    age: 2,
    weightKg: 4,
    color: "White (Winter), Brown (Summer)",
...
function getAnimalsByColor(animalColor) {
  const animalsByColor = animalsCollection.filter(element => {
    return element.color.toLowerCase().includes(animalColor.toLowerCase())
  })
  return animalsByColor.length
}
