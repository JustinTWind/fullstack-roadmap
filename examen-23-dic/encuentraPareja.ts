const personas = [
  ...
  },
  {
    nombre: "Lucas",
    edad: 24,
    intereses: ["Videojuegos", "Ciclismo"],
    ciudad: "Bogotá",
    genero: "Masculino",
  },
  {
  ...
  },
  {
    nombre: "Sebastián",
    edad: 26,
    intereses: ["Ciclismo", "Videojuegos"],
    ciudad: "Bogotá",
    genero: "Masculino",
  },
  {
  ...
  },
  {
    nombre: "Valentina",
    edad: 57,
    intereses: ["Videojuegos", "Fotografía"],
    ciudad: "Bogotá",
    genero: "Femenino",
  },
  {
  ...
  },
  {
    nombre: "Andrés",
    edad: 42,
    intereses: ["Programación", "Senderismo"],
    ciudad: "Bogotá",
    genero: "Masculino",
  },
  {
...
function encontrarParejaEnLaCiudad(
  personaObjetivo: Persona
): Persona | undefined {
  const indexPareja = personas.findLastIndex((element) => {
    return (
      personaObjetivo.genero !== element.genero &&
      personaObjetivo.ciudad === element.ciudad
    );
  });

  return personas[indexPareja] as Persona;
}

console.log(
  encontrarParejaEnLaCiudad({
    nombre: "Camilo",
    edad: 28,
    intereses: ["Arte"],
    ciudad: "Medellín",
...
function encontrarParejasPotencialesPorEdad(
  personaObjetivo: Persona
): Persona[] | undefined {
  const parejasPotenciales = [];

  for (const persona of personas) {
    if (
      persona.ciudad === personaObjetivo.ciudad &&
      persona.genero !== personaObjetivo.genero &&
      Math.abs(persona.edad - personaObjetivo.edad) < 5
    ) {
      parejasPotenciales.push(persona);
    }
  }

  return parejasPotenciales as Persona[];
}

console.log(
  encontrarParejasPotencialesPorEdad({
    nombre: "Camilo",
    edad: 28,
    intereses: ["Arte"],
    ciudad: "Medellín",
...
function encontrarParejaPorInteres(
  personaObjetivo: Persona
): Persona[] | undefined {
  const parejasPotenciales = [];

  for (const persona of personas) {
    const hasInterestInCommon = persona.intereses.some((element) => {
      return personaObjetivo.intereses.includes(element);
    });
...
console.log(
  encontrarParejaPorInteres({
    nombre: "Camilo",
    edad: 28,
    intereses: ["Arte", "Programacion", "Lectura", "Viajes"],
    ciudad: "Bogotá",
    genero: "Masculino",
  })
);
