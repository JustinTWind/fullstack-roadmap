...
/*
  ...
  1. create a function that returns an array of books based on chapters number, the function should be named "getBooksByChaptersNumber",
  the function should receive only one parameter that is the minimum chapters that the book should have.

*/

function getBooksByChaptersNumber(minimunChapters) {
  return bookCollection.filter((element) => {
    return element.chapters >= minimunChapters;
  });
}

console.log(getBooksByChaptersNumber(30));
console.log(getBooksByChaptersNumber(2));
...
function getBooksByGenre(givenGenre) {
  return bookCollection.filter((element) => {
    return element.genre.includes(givenGenre);
  });
}
...
/*
  ...
  3. create a function that returns an array of books based on amazon rating,
  the function should be named "getBooksByAmazonRating", the function should receive only one number parameter
  that is the minimum amazon rating that the book should have.

*/

function getBooksByAmazonRating(minimunRating) {
  return bookCollection.filter((element) => {
    return element.ratings[1].score >= minimunRating;
  });
}
